			...
			<div className="flex h-full w-full flex-col overflow-hidden border border-border bg-background shadow-2xl md:h-[90vh] md:max-w-4xl md:rounded-xl">
				...
				<div className="flex min-h-0 min-w-0 flex-1 flex-col md:flex-row">
					...
					<main className="min-w-0 flex-1 overflow-y-auto overflow-x-hidden">
						<div
							key={activeTab}
							className="settings-content-enter min-w-0 space-y-6 overflow-x-hidden p-4 pb-safe-area-inset-bottom md:space-y-8 md:p-6"
						>
							{activeTab === "appearance" && (
								<AppearanceSettingsTab
									...
									onCodeEditorWordWrapChange={(value) =>
										updateCodeEditorSetting("wordWrap", value)
									}
									onCodeEditorShowMinimapChange={(value) =>
										updateCodeEditorSetting("showMinimap", value)
									}
									onCodeEditorLineNumbersChange={(value) =>
										updateCodeEditorSetting("lineNumbers", value)
									}
									onCodeEditorFontSizeChange={(value) =>
										updateCodeEditorSetting("fontSize", value)
									}
								/>
							)}
