...
import type {
	...
	SearchProgress,
} from "../../hooks/useSidebarController";
import type {
...
function formatCompactArchivedAge(dateString: string | null): string {
	...
	const diffInMinutes = Math.floor(
		Math.max(0, Date.now() - date.getTime()) / (1000 * 60),
	);
	if (diffInMinutes < 1) {
		return "<1m";
	}
...
export default function SidebarContent({
	...
	const isRenamingOnMobile =
		isMobile &&
		Boolean(projectListProps.editingProject || projectListProps.editingSession);
